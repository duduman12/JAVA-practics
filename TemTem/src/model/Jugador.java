...
public class Jugador {
	...
	public Jugador (String id, String name, Alta data, ArrayList<Objeto> objects, ArrayList<Temtem> temtems ) {
		this.id = id;
		this.nombre = name;
		this.alta = data;
	...
	public String toString() {
		return "Jugador [id=" + id + ", nombre=" + nombre + ", alta=" + alta + ", objetos=" + objetos + ", temtems="
				+ temtems + "]";
	}
